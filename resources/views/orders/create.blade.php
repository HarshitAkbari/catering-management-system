                ...
                <form action="{{ route('orders.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="customer_name" id="customer_name" required value="{{ old('customer_name') }}" class="form-control">
                            @error('customer_name')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="email" name="customer_email" id="customer_email" required value="{{ old('customer_email') }}" class="form-control">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="customer_mobile" class="form-label">Contact Number <span class="text-danger">*</span></label>
                            <input type="text" name="customer_mobile" id="customer_mobile" required value="{{ old('customer_mobile') }}" class="form-control">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="address" id="address" rows="3" required class="form-control">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
