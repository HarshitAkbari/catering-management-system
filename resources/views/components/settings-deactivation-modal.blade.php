@props([
    'modalId' => 'settings-deactivation-modal',
    'settingType' => 'setting',
    'formMethod' => 'GET',
    'csrfMethod' => 'GET',
])

{{-- Settings Deactivation Confirmation Modal --}}
            ...
            <form id="{{ $modalId }}-form" method="{{ $formMethod }}" action="">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="{{ $modalId }}Label">
                        Deactivate <span id="{{ $modalId }}-setting-name"></span>
                    </h5>
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        ...
                        <h6 class="fw-bold">
                            Are you sure you want to deactivate this <span id="{{ $modalId }}-setting-type">{{ $settingType }}</span>?
                        </h6>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <ul class="mb-0" style="list-style: none; padding-left: 0;">
                                <li class="mb-2 d-flex align-items-start">
                                    ...
                                    <span>This <span class="setting-type-text">{{ $settingType }}</span> will no longer be available for future use</span>
                                </li>
                                <li class="mb-2 d-flex align-items-start">
                                    <i class="bi bi-shield-check text-success me-2" style="font-size: 1rem; margin-top: 2px;"></i>
                                    <span>All existing data associated with this <span class="setting-type-text">{{ $settingType }}</span> will be preserved and remain unchanged</span>
                                </li>
                                <li class="mb-0 d-flex align-items-start">
                                    <i class="bi bi-telephone text-primary me-2" style="font-size: 1rem; margin-top: 2px;"></i>
                                    <span>For permanent deletion, please contact Support</span>
                                </li>
                            </ul>
                        </div>
                    </div>
...
function showSettingsDeactivationModal(modalId, settingName, settingType, formAction, csrfMethod = 'GET') {
