...
<div
    id="toast-{{ uniqid() }}"
    class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 {{ $config['bg'] }} rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 fixed {{ $positionClass }} z-50"
    role="alert"
    x-data="{ show: true }"
    x-show="show"
