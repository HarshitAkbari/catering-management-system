                ...
                <div class="card-header">
                    <div class="d-flex flex-column">
                        <div class="d-flex align-items-center gap-2">
                            <h4 class="card-title">{{ $page_title ?? 'Equipment Statuses' }} List</h4>
                        </div>
                        <div class="d-flex align-items-center gap-2 mt-2">
                            <h6 class="card-subtitle text-muted">
                                Manage and organize equipment statuses for your catering equipment
                            </h6>
                        </div>
                    </div>
                    <a href="{{ route('settings.equipment-statuses.create') }}" class="btn btn-primary btn-add">Add {{ $page_title ?? 'Equipment Status' }}</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="datatable display">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">No equipment statuses found. <a href="{{ route('settings.equipment-statuses.create') }}">Create one</a></td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
